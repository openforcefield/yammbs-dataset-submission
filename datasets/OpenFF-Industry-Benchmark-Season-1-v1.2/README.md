...
In this submission we prepare the *OpenFF Industry Benchmark Season 1 v1.2* dataset directly for use using the command: `python new_dataset.py industry.yaml -n 2 > log.txt`