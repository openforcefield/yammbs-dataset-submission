Force field file is from [1], filename `proteinbenchmark/data/force-fields/null-0.0.3-4-mer-aaqaa3-1e3-opc3-qm-NAGL.offxml`

Using code name `Rosemary-alpha0-QM`
